...
const StoreItem = ({id, name, price, imgUrl}:StoreItemProps)=>{
    ...
    const quantity = getItemQuantity(id); //gets the item from the id based qty from the context
        ...
        <Card className="h-100">
            ...
            <Card.Body className="d-flex flex-column">
                ...
                <div className="mt-auto">
                    {quantity === 0 ? (
                        <Button className="w-100" onClick={()=>increaseCartQty(id)}> + Add to Cart</Button>
